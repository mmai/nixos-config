...
let mailspring-deb = pkgs.stdenv.mkDerivation rec {
  ...
  src = pkgs.fetchurl {
    ...
    # sha256 = "0lahvfvxwqbnp12qqc6pzbv5vnr3fr9i11af8lqrdjsd1ylsb73r"; # 1.6.3
    # sha256 = "0bd1jvpcqv8kap4zb4n4vssdnl69d0vbwxa95vz97hji674wv4kw"; # 1.7.4 # bug with office365: https://github.com/Foundry376/Mailspring/issues/1839
    sha256 = "1ijpbzijn58xnbgnrbzqnj709msmknvsxsdmlb2qz28gjp5kk05s"; # 1.7.2
  };
